...
# Enlazando de la keyword blockchain ¿Que se puede guardar en un blockchain?

A alguien se le ocurrió que puede guardar tokens para realizar transacciones monetarias.

- **Token:** Es una base de datos como una hoja de excel, pero contiene columnas nada más y solo permite escribir un dato nuevo.
...
(Se puede preguntar a los participantes que cosas se les ocurre hacer con una base de datos así de limitada. Sí después de 7 segundos nadie contesta, sugerir implementarla en transacciones de un gobierno, obteniendo transparencia obligada por el sistema.
  - **Esqueumórficos de blockchain:** 
*Libro contable, ledger:* <- No todos est
